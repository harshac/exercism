...
// Commit: 65cc51b Update chromaticScale-generator version to 2.0.0
...
var scaleTestCases = []scaleTest{
	{
		description: "Chromatic chromaticScale with sharps",
		tonic:       "C",
		interval:    "",
		expected:    []string{"C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"},
	},
	{
		description: "Chromatic chromaticScale with flats",
		tonic:       "F",
		interval:    "",
		expected:    []string{"F", "Gb", "G", "Ab", "A", "Bb", "B", "C", "Db", "D", "Eb", "E"},
	},
	{
		description: "Simple major chromaticScale",
		tonic:       "C",
		interval:    "MMmMMMm",
		expected:    []string{"C", "D", "E", "F", "G", "A", "B"},
	},
	{
		description: "Major chromaticScale with sharps",
		tonic:       "G",
		interval:    "MMmMMMm",
		expected:    []string{"G", "A", "B", "C", "D", "E", "F#"},
	},
	{
		description: "Major chromaticScale with flats",
		tonic:       "F",
		interval:    "MMmMMMm",
		expected:    []string{"F", "G", "A", "Bb", "C", "D", "E"},
	},
	{
		description: "Minor chromaticScale with sharps",
		tonic:       "f#",
		interval:    "MmMMmMM",
		expected:    []string{"F#", "G#", "A", "B", "C#", "D", "E"},
	},
	{
		description: "Minor chromaticScale with flats",
		tonic:       "bb",
		interval:    "MmMMmMM",
